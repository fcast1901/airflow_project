...
def _collect_climate_data():
    ...
    #with this we can avoid calling the api for the same zip code and entering duplicate data
    #this was necessary after adding the sensor and the possibility of the dag being triggered multiple times per day if there are new zip codes.
